...
const s = StyleSheet.create({
  ...
  ptAvatar: { width: 64, height: 64, borderRadius: 32, backgroundColor: '#dcfce7', alignItems: 'center', justifyContent: 'center', marginBottom: 12 },
  ptAvatarText: { fontSize: 28, fontWeight: '700', color: '#16a34a' },
  ...
  answerBox: { backgroundColor: '#f0fdf4', borderRadius: 10, padding: 12 },
  ...
  ratingBtnActive: { backgroundColor: '#16a34a', borderColor: '#16a34a' },
  ...
  yesNoBtnActive: { backgroundColor: '#16a34a', borderColor: '#16a34a' },
  yesNoText: { fontSize: 16, fontWeight: '600', color: '#9ca3af' },
  yesNoTextActive: { color: '#fff' },
  submitBtn: { backgroundColor: '#16a34a', borderRadius: 12, paddingVertical: 16, alignItems: 'center', marginTop: 8 },
