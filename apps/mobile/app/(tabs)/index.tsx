...
const makeStyles = (c: BrandColors) => StyleSheet.create({
  ...
  heroGlow: {
    ...
    height: 150,
    borderRadius: 75,
    backgroundColor: 'rgba(245, 241, 234, 0.035)',
  },
  heroHeader: {
    flexDirection: 'row',
  ...
  heroBadgeText: { color: 'rgba(245,241,234,0.8)', fontSize: 11, fontWeight: '600' },
  greeting: { fontSize: 18, fontWeight: '700', color: 'rgba(245,241,234,0.76)' },
  heroTitle: {
    marginTop: 6,
    fontSize: 30,
    lineHeight: 34,
