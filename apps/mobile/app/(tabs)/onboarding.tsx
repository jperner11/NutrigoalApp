...
const st = StyleSheet.create({
  ...
  timeBtnActive: { borderColor: '#16a34a', backgroundColor: '#f0fdf4' },
  timeBtnText: { fontSize: 14, fontWeight: '600', color: '#6b7280' },
  timeBtnTextActive: { color: '#16a34a' },
  // Day pickers
  ...
  dayBtnActive: { borderColor: '#16a34a', backgroundColor: '#f0fdf4' },
  dayBtnText: { fontSize: 18, fontWeight: '700', color: '#6b7280' },
  dayBtnTextActive: { color: '#16a34a' },
  // Review
  ...
  reviewSection: { fontSize: 14, fontWeight: '700', color: '#16a34a', marginBottom: 2 },
  ...
  aiNote: { flexDirection: 'row', backgroundColor: '#dcfce7', borderRadius: 12, padding: 14, gap: 10, marginTop: 8, alignItems: 'flex-start' },
  aiNoteText: { fontSize: 13, color: '#166534', flex: 1, lineHeight: 18 },
  // Nav
