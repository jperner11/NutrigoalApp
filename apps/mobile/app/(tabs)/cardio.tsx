...
const styles = StyleSheet.create({
  ...
  cardCalories: { fontSize: 15, fontWeight: '700', color: '#16a34a' },
  ...
  previewCard: { backgroundColor: '#dcfce7', borderRadius: 12, padding: 16, alignItems: 'center', marginTop: 16 },
  previewLabel: { fontSize: 13, color: '#166534' },
  previewValue: { fontSize: 28, fontWeight: '800', color: '#16a34a', marginTop: 4 },
