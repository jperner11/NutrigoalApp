...
import type { TrainingPlan } from '@nutrigoal/shared'
      ...
      >
        {plans.length === 0 ? (
          <View style={styles.empty}>
            ...
            <Text style={styles.emptySubtext}>Create a workout plan to start training</Text>
          </View>
        ) : (
          plans.map((plan) => (
            <View key={plan.id} style={styles.card}>
              ...
              <Text style={styles.cardSub}>{plan.days_per_week} days/week</Text>
            </View>
          ))
        )}
      </ScrollView>
