...
export default function TermsPage() {
  return (
    <PublicPageShell
      ...
      title="The rules for using mealandmotion during beta"
    ...
    >
      <section className="panel-strong p-8">
        ...
        <div className="mt-6 space-y-5 text-sm leading-7 text-[var(--muted)]">
          <p>By using mealandmotion, you agree to use the service lawfully, keep your account secure, and provide accurate information where it materially affects coaching, plans, or safety.</p>
